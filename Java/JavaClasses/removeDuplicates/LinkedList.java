package Java.JavaClasses.removeDuplicates;
...
class LinkdedList<T> {
    ...
    private void deleteDuplicatesInner(Node<T> node) {
    ...
    public void deleteDuplicates() {
        deleteDuplicatesInner(this.head);
    }

    public Node<T> removeElements(Node<T> head, Node<T> val) {
        Node<T> cur = head;
        Node<T> prev = null;
        while(cur!=null){
            if(prev.next == val)
    ...
    public static void main(String[] args) {
        LinkdedList<Integer> linkedList = new LinkdedList<Integer>();
        ...
        linkedList.append(2);
        linkedList.append(4);
        linkedList.removeElements(null, null);
